...
export default function MentorCarousel({
  ...
  return (
    <div className="relative w-full   grid place-items-center bg-mainLighter h-auto " id="mentors">
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center w-full bg-dark py-9 font-bold">Speakers</h1>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center h-full text-center md:text-left gap-6 md:gap-9 ">
                <img
                  src={mentor.photo}
                  alt={mentor.name}
                  className="w-32 h-32 md:w-40 md:h-40 lg:w-52 lg:h-52 border-2 border-white p-3 rounded-xl object-cover mb-4 md:mb-0 "
                />
                <div className="custom-border px-2 py-6 md:px-12  bg-white mr-4 ">
