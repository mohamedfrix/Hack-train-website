...
export default function Event() {
  return (
    <section className="flex flex-col items-center max-w-screen py-32 overflow-hidden gap-y-7 min-h-screen " id='about'>
      <div className="relative border-violetMedium border-4 rounded-2xl  w-2/3  bg-dark z-10">
        <img
          src={purpleBinaries}
          alt=""
